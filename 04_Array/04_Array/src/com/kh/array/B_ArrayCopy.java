...
//		System.arrycopy(원본 배열명, 원본 배열의 복사를 시작할 인덱스, 복사본 배열명, 복사본 배열의
//		복사될 시작 인덱스, 복사할 갯수)
//		System.arraycopy(origin, 0, copy, 0, 5);// 1 2 3 4 5 0 0 0 0 0
//		System.arraycopy(origin, 0, copy, 2, 5);// 0 0 1 2 3 4 5 0 0 0
//		System.arraycopy(origin, 2, copy, 1, 3);// 0 0 3 4 5 0 0 0 0 0
...
//		복사본 배열 = Arrays.copyOf(원본배열명, 복사할 갯수)
		int[] copy = Arrays.copyOf(origin, 1); // copy배열의 크기 == 복사할 갯수
...
//		복사본 배열 = 원본배열.clone();
		int[] copy = origin.clone();// 인덱스 직접 지정 x, 복사할 갯수 지정 x
