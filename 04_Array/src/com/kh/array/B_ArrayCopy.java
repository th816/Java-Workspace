...
public class B_ArrayCopy {
	 ...
	 * - 얕은 복사 : 배열의 주소값만 복사
	 * 
	 * - 깉은 복사 : 동일한 새로운 배열을 하나 더 만들어서 실제 내부값들을 복사
	 * 
	 * 
	 * 
	 */
	...
	public void method1() {
		...
		int origin[] = {1,2,3,4,5}; //->이 데이터복사하기
	...
	public void method4() {
		 ...
		 * 개수만큼 복사가 진행됨 내가 제시한 길이가 원본배열도 크다면 나머지에는 0의값으로
		 * 채워서 복사해줌
		 * 
		 * 
		 * 
	...
	public void method5() {
		...
		//복사본 배열 = 원본배열.clone();
		int copy[] = origin.clone(); //인덱스 직접지정x, 복사갯수지정x
		//무조건 원본배열과 동일한 녀석이 반한됨.
