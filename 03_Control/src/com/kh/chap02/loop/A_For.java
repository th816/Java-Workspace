...
public class A_For {
	 ...
	 * 
	 * [표현법]
	 * for(초기식 ; 조건식 ; 증감식){ // 세미콜론을 통해서 구분. 무조건 세미콜론이 있어야됨
	 ...
	 *      -> 조건식(조건검사) -> true일 경우 실행할 코드 실행 -> 증감식
	 *      -> 조건식(조건검사) -> false경우 실행할 코드 실행 x 증감식 x
	 *      
	 * 매번 조건식의 조건검사 결과 값을 가지고 조건이 true일 경우만 반복해서 실행한다.     
	 *
	 * 알아둘것 :
	...
	public void method1() {
		...
		//초기식, 조건식, 증감식이 없더라도 문법적 오류는 아님, 다만 무한루프
		...
		public void method6() {
			...
			if(num > 0) {
				...
				System.out.println("1부터 "+num+"까지 총 합계 :"+sum);
		...
		public void method8() {
			 ...
			 * 
			 * 
			 * random() : 0.0~ 0.99999999....사이의 랜덤값 발생
			 * 0.0 <=  / 랜덤값 < 1.0
			 * 
			 * 
			 */
			...
			//1을 더해보자
			//1.0 <=랜덤값 <11.0
			//소수점만 버려 버리면, 원하는 범위의 정수 랜덤값을 가져올수가 있음
			//1<= 랜덤값 <=10
		...
		public void method9() {
			 ...
			 * o=>str.charAt(4);
			 * 
			 * 규칙을 찾기. 우선 반복적으로 str.charAt(0)을 호출함.
